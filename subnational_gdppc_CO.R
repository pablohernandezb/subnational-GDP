...
plot_title <- "PIB per cápita de COlombia (2021) cada 0.25°x 0.25°"
...
print(colombia_state_map)

# --- Plot 2: Municipality Level Map ---
plot_title_municipality <- "PIB per cápita de Colombia (2021) ponderado por municipio"
...
plot_title_municipality_EN <- "Colombia GDP per capita (2021) by municipality"
...
colombia_municipality_map <- ggplot() +
  geom_sf(
...
print(colombia_municipality_map)
