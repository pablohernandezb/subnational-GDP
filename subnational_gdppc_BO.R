...
plot_title_EN <- "Bolivia GDP per Capita (2021) by 0.25°x 0.25° cells"
...
ggsave("bolivia_gdp_map.png", plot = bolivia_map, width = 8, height = 6, dpi = 300)
...
color_name <- "GDP per capita (USD)"
color_name_EN <- "PIB per cápita (USD)"

# --- Plot 1: State Level Map ---
plot_title_state <- "PIB per cápita de Bolivia (2021) ponderado por departamento"
plot_subtitle_state <- "Precios corrientes (USD)"
plot_caption_state <- "©2025 Pablo Hernández Borges | pablohernandezb.dev\nDatos: Rossi-Hansberg & Zhang (2025)"

plot_title_state_EN <- "Bolivia GDP per capita (2021) by department"
